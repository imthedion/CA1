...
=======
<<<<<<< HEAD
router.get('/get/html', function(req, res) {4
=======
router.get('/get/html', function(req, res) {

>>>>>>> 0fc302498f1432769deb2a7abd72fb8fa2b5f0bd
>>>>>>> ac28a69e9ca6edc4a67e2d5818f7ac97b8c3a303
    res.writeHead(200, {'Content-Type': 'text/html'}); //We are responding to the client that the content served back is HTML and the it exists (code 200)

    var xml = fs.readFileSync('tippenyaki.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('tippenyaki.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('tippenyaki.xml', function(err, result) {
      if (err) throw (err);
      ...
      jsToXmlFile('tippenyaki.xml', result, function(err) {
